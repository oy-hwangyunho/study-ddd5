...
insert into large_category (d_cat_cd, title, priority, use_yn, created_at, updated_at)
values ('003', '바지', 3, 'Y', now(), now());
insert into middle_category (d_cat_cd, title, large_category_id, priority, use_yn, created_at, updated_at)
values ('003002', '데님 팬츠', 3, 1, 'Y', now(), now());
insert into middle_category (d_cat_cd, title, large_category_id, priority, use_yn, created_at, updated_at)
values ('003007', '코튼 팬츠', 3, 2, 'Y', now(), now());
insert into middle_category (d_cat_cd, title, large_category_id, priority, use_yn, created_at, updated_at)
values ('003008', '슈트 팬츠/슬랙스', 3, 3, 'Y', now(), now());
insert into middle_category (d_cat_cd, title, large_category_id, priority, use_yn, created_at, updated_at)
values ('003004', '트레이닝/조거 팬츠', 3, 4, 'Y', now(), now());
insert into middle_category (d_cat_cd, title, large_category_id, priority, use_yn, created_at, updated_at)
values ('003009', '숏 팬츠', 3, 5, 'Y', now(), now());
insert into middle_category (d_cat_cd, title, large_category_id, priority, use_yn, created_at, updated_at)
values ('003010', '점프 슈트/오버올', 3, 6, 'Y', now(), now());
insert into middle_category (d_cat_cd, title, large_category_id, priority, use_yn, created_at, updated_at)
values ('003006', '기타 바지', 3, 7, 'Y', now(), now());
